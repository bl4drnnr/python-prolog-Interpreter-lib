...
def test_simple_goal_query():
    ...
    knowledge_database = KnowledgeDatabase(rules_text)
    solution = knowledge_database.find_solutions(goal_text)
...
def test_simple_variable_query():
    ...
    knowledge_database = KnowledgeDatabase(rules_text)
    solutions = knowledge_database.find_solutions(query_text)
...
def test_multiple_var_query():
    ...
    knowledge_database = KnowledgeDatabase(rules_text)
    solution_map = knowledge_database.find_solutions(query_text)
...
def test_einstein_puzzle():
    ...
    assert (
        "japanese" in str(solution) for solution in solutions.get("ZebraOwner")
    )
